...
$pagerPath = (string)($pagination['path'] ?? '/my/bookmarks');
...
$emptyTitle = $selectedCategorySlug !== '' ? 'В этой категории нет закладок' : 'Пока нет закладок';
    ...
    <div class="empty-state__card">
        ...
        <?php if ($selectedCategorySlug === ''): ?>
            <a href="/" class="btn btn--primary">
                <img src="/assets/img/arrow-right.svg" class="btn-icon" width="16" height="16" style="filter: invert(1)" aria-hidden="true">
                Перейти к тестам
            </a>
        <?php endif; ?>
    </div>
...
<div data-bookmarks-list-wrap<?= empty($tests) ? ' class="is-hidden"' : '' ?>>
    <div class="test-card-grid" data-bookmarks-list>
